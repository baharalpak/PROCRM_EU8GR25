...
public class WorkGroupStepDefs {
    ...
    @When("{string} clicks on dropdown menu")
    public void clicks_on_dropdown_menu(String string) {
    ...
    @Then("{string} can see the sorted groups")
    public void can_see_the_sorted_groups(String string) {
